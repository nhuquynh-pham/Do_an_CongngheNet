...
namespace Do_an_CongngheNET
{
    public partial class Dangkyoxepphong : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            // Kiểm tra quyền trước — nếu không có quyền: giữ form trống,
            // BeginInvoke hiện thông báo rồi đóng, không load gì cả
            if (!SessionManager.CoQuyen("CN004"))
            {
                ...
                return; // dừng lại, không KhoiTaoForm / TaiDuLieu
            }

            // Có quyền → khởi tạo bình thường
            KhoiTaoForm();
            TaiDuLieu();
